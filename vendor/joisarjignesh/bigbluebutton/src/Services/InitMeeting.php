...
trait InitMeeting
{
    ...
    public function initCreateMeeting(array $parameters)
    {
        ...
        $meetingParams->setRecord($request->get('record', config('bigbluebutton.create.record', true)));
        ...
        if (!is_null($request->get('logoutUrl', config('bigbluebutton.create.logoutUrl', null)))) {
            $meetingParams->setLogoutUrl($request->get('logoutUrl', config('bigbluebutton.create.logoutUrl', true)));
        }
