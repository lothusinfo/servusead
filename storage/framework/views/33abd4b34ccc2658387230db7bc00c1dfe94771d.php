...
unset($__errorArgs, $__bag); ?></div>
                                ...
                                <div class="form-group <?php if(!$errors->has('user_id') and empty($notification->user)): ?> d-none <?php endif; ?>" id="userSelect">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/notifications/send.blade.php ENDPATH**/ ?>