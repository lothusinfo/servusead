    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="/admin/store/filters"><?php echo e(trans('admin/main.filters')); ?></a>
                </div>
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/store/filters/<?php echo e(!empty($filter) ? $filter->id.'/update' : 'store'); ?>"
                                  method="Post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/servusead/resources/views/admin/store/filters/create.blade.php ENDPATH**/ ?>