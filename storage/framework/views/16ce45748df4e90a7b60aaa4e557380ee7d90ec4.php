<div id="chapterModalHtml" class="d-none">
    <div class="custom-modal-body">
        ...
        <div class="js-content-form chapter-form mt-20" data-action="/panel/chapters/store">
            ...
            <div class="form-group">
                <label class="input-label"><?php echo e(trans('public.chapter_title')); ?> <span style='color:red;'>*</span></label>
...
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/web/default/panel/webinar/create_includes/chapter_modal.blade.php ENDPATH**/ ?>