    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Servus EaD</h1>
                <h5 class="font-weight-normal text-muted-transparent">A plataforma educacional completa</h5>
              </div>
...
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>