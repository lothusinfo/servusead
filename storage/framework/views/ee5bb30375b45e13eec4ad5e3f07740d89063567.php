                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="sender" data-plugin-selectTwo class="form-control populate">
                                            <option value="">Selecione remetente</option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/noticeboards/lists.blade.php ENDPATH**/ ?>