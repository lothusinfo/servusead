        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="/admin/store/specifications"><?php echo e(trans('update.specifications')); ?></a>
                </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/store/specifications/<?php echo e(!empty($specification) ? $specification->id.'/update' : 'store'); ?>"
                                  method="Post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/servusead/resources/views/admin/store/specifications/create.blade.php ENDPATH**/ ?>