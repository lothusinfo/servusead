                            ...
                            <table class="table table-striped text-center font-14">
                                ...
                                <?php $__currentLoopData = $product->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" value="<?php echo nl2br($file->description); ?>">
                                        ...
                                        <td width="160" class="text-right">
                                            ...
                                            <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/store/products/files/'. $file->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
...
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/store/products/create/image_and_files.blade.php ENDPATH**/ ?>