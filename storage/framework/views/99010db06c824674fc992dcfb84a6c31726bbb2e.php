...
<div class="row">
    <div class="col-12 col-md-4 mt-15">
        <span style='color:red;'>* (Preenchimento obrigatório)</span>
        ...
        <div class="form-group mt-15 ">
            <label class="input-label d-block"><?php echo e(trans('panel.course_type')); ?> <span style='color:red;'>*</span></label>
...
unset($__errorArgs, $__bag); ?>">
                    <option value="" <?php echo e((!empty($webinar) and !empty($webinar->teacher_id)) ? '' : 'selected'); ?>>
                        <?php echo e(trans('public.choose_instructor')); ?></option>
                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($teacher->id); ?>"
                            <?php echo e(!empty($webinar) && $webinar->teacher_id == $teacher->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            <label class="input-label"><?php echo e(trans('public.thumbnail_image')); ?> <span style='color:red;'>*</span></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            <label class="input-label"><?php echo e(trans('public.cover_image')); ?> <span style='color:red;'>*</span></label>
            <div class="input-group">
                <div class="input-group-prepend">
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/web/default/panel/webinar/create_includes/step_1.blade.php ENDPATH**/ ?>