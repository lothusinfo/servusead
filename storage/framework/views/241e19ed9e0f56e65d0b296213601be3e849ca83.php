...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="title" value="<?php echo e(!empty($bundle_translation) ? $bundle_translation->title : old('title')); ?>" class="form-control <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/bundles/create.blade.php ENDPATH**/ ?>