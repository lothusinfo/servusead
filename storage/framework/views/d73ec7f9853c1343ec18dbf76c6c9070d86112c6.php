<div class="accordion-row bg-white rounded-lg border border-gray300 mt-3 py-3 py-lg-4 px-2 px-lg-3">
    <div class="d-flex align-items-center justify-content-between " role="tab" id="faq_<?php echo e(!empty($faq) ? $faq->id :'record'); ?>">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(!empty($faq)): ?>
                <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/store/products/faqs/'. $faq->id .'/delete','btnClass' => 'mr-3', 'btnText' => '<i class="fa fa-trash"></i>'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
    ...
    <div id="collapseFaq<?php echo e(!empty($faq) ? $faq->id :'record'); ?>" aria-labelledby="faq_<?php echo e(!empty($faq) ? $faq->id :'record'); ?>" class=" collapse <?php if(empty($faq)): ?> show <?php endif; ?>" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="js-content-form faq-form" data-action="/admin/store/products/faqs/<?php echo e(!empty($faq) ? $faq->id . '/update' : 'store'); ?>">
...
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/store/products/create/accordions/faq.blade.php ENDPATH**/ ?>