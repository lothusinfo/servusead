<div class="row">
    ...
    <div class="col-7">
        <div class="form-group">
            <label class="input-label" for="mobile"><?php echo e(trans('auth.mobile')); ?> <?php echo e(!empty($optional) ? "(". trans('public.optional') .")" : ''); ?> <?= !empty($required) ? "<span style='color:red;'>*</span>" : '' ;?>: </label>
            <input name="mobile" type="number" class="form-control <?php $__errorArgs = ['mobile'];
...
unset($__errorArgs, $__bag); ?> ls-mask-phone8_with_ddd" value="<?php echo e(old('mobile')); ?>" id="mobile" aria-describedby="mobileHelp" placeholder="DDD + 00000000" required>
