...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="point" value="<?php echo e(!empty($product) ? $product->point : old('point')); ?>" class="form-control <?php $__errorArgs = ['point'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/store/products/create/basic_information.blade.php ENDPATH**/ ?>