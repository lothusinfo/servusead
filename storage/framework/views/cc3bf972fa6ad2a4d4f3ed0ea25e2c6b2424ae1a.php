        ...
        <div class="tab-item-info mt-15">
            ...
            <div class="d-flex align-items-center justify-content-between mt-15">
                <label class="mb-0 mr-10 cursor-pointer font-weight-normal font-14 text-dark-blue"
                    for="readToggle<?php echo e($type); ?><?php echo e($item->id); ?>"><?php echo e(trans('public.i_passed_this_lesson')); ?></label>
                <div class="custom-control custom-switch">
                    <input type="checkbox" <?php if($sequenceContentHasError): ?> disabled <?php endif; ?>
                        id="readToggle<?php echo e($type); ?><?php echo e($item->id); ?>" data-item-id="<?php echo e($item->id); ?>"
                        data-item="<?php echo e($type); ?>_id" value="<?php echo e($item->webinar_id); ?>"
                        class="js-passed-lesson-toggle custom-control-input"
                        <?php if(!empty($item->learningStatus)): ?> checked <?php endif; ?>>
                    <label class="custom-control-label"
                        for="readToggle<?php echo e($type); ?><?php echo e($item->id); ?>"></label>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/web/default/course/learningPage/components/content_tab/content.blade.php ENDPATH**/ ?>