...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12 <?php if($webinar->isWebinar()): ?> col-md-6 <?php endif; ?>">
                <div class="form-group">
                    <label class="input-label"><?php echo e(trans('public.duration')); ?> (<?php echo e(trans('public.minutes')); ?>) <span style='color:red;'>*</span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            <label class="input-label"><?php echo e(trans('public.category')); ?> <span style='color:red;'>*</span></label>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\servusead\resources\views/web/default/panel/webinar/create_includes/step_2.blade.php ENDPATH**/ ?>