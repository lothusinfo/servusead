...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(!empty($CertificateTemplateTranslation) ? $CertificateTemplateTranslation->title : old('title')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="9" name="body"><?php echo e((!empty($CertificateTemplateTranslation)) ? $CertificateTemplateTranslation->body : old('body')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servusead\resources\views/admin/certificates/new_templates.blade.php ENDPATH**/ ?>