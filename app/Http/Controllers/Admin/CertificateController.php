...
class CertificateController extends Controller
{
    ...
    public function CertificatesTemplatesEdit(Request $request, $template_id)
    {
        ...
        $template = CertificateTemplate::findOrFail($template_id);
        $CertificateTemplateTranslation = CertificateTemplateTranslation::where('certificate_template_id', $template_id)->first();
        ...
        $data = [
            ...
            'template' => $template,
            'CertificateTemplateTranslation' => $CertificateTemplateTranslation
        ];
        return view('admin.certificates.new_templates', $data);
    }
