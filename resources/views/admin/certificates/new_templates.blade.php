                ...
                <div class="card-body">
                    ...
                    <form method="post" action="" id="templateForm" class="form-horizontal form-bordered">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ !empty($CertificateTemplateTranslation) ? $CertificateTemplateTranslation->title : old('title') }}">
                        ...
                        <div class="form-group ">
                            ...
                            <textarea class="form-control @error('body') is-invalid @enderror" rows="9" name="body">{{ (!empty($CertificateTemplateTranslation)) ? $CertificateTemplateTranslation->body : old('body') }}</textarea>
