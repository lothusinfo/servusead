    ...
    <div class="col-12 col-md-6 mt-15">
        ...
        <div class="row mt-15">
            ...
            <div class="col-12 @if($webinar->isWebinar()) col-md-6 @endif">
                <div class="form-group">
                    <label class="input-label">{{ trans('public.duration') }} ({{ trans('public.minutes') }}) <span style='color:red;'>*</span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
        ...
        <div class="form-group mt-15">
            <label class="input-label">{{ trans('public.category') }} <span style='color:red;'>*</span></label>
