...
<div class="row">
    <div class="col-12 col-md-4 mt-15">
        ...
        <div class="form-group mt-15 ">
            <label class="input-label d-block">{{ trans('panel.course_type') }} <span style='color:red;'>*</span></label>
        ...
        <div class="form-group mt-15">
            <label class="input-label">{{ trans('public.thumbnail_image') }} <span style='color:red;'>*</span></label>
        ...
        <div class="form-group mt-15">
            <label class="input-label">{{ trans('public.cover_image') }} <span style='color:red;'>*</span></label>
            <div class="input-group">
                <div class="input-group-prepend">
